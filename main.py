...
class App():
    def __init__(self) -> None:
        ...
        self.FALLING_SUN_FALLING_SPEED = 5  # How quickly the sun falls
        ...
        self.FALLING_SUN_PATH_LENGTH_RANGE = [400, 800]
    ...
    def seeds_event_handling(self, event):
        ...
        for seed in self.seeds:
            ...
            hovering.append(True if seed.is_cursor_hovering() else False)
    ...
    def summon_sun(self, source: str = "sky"):
        why = FallingSun(self.FALLING_SUN_FALLING_SPEED, self.FALLING_SUN_PICKUP_SPEED, self.FALLING_SUN_STARTING_Y_POS,
                         self.FALLING_SUN_STARTING_X_POS_RANGE, self.FALLING_SUN_PATH_LENGTH_RANGE, self.SUN_DISPLAY_POS, self.screen)
        self.pickable_suns.append(why)
